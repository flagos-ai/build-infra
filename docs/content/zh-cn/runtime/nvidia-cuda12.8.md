...
<div class="ms-3"><code class="plain">harbor.baai.ac.cn/flagos-base/flagos-base-nvidia-cuda12.8:2.2.0</code> <a href="../../base/nvidia-cuda12.8/" title="查看基础镜像详情" aria-label="查看基础镜像详情"><i class="material-icons align-middle size-20">open_in_new</i></a></div>
