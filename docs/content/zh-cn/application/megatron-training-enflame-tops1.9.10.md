---
title: "megatron-training-enflame-tops1.9.10"
---
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-enflame-tops1.9.10:2.1.2-0.2.1 bash
```
...
docker run --rm -it \
  ...
  -e ENFLAME_VISIBLE_DEVICES=all \
  -e TENCENT_VISIBLE_DEVICES=all \
  harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-enflame-tops1.9.10:2.1.2-0.2.1 megatron-train --model-type GPT
```
