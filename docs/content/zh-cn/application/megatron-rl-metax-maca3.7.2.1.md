---
title: "megatron-rl-metax-maca3.7.2.1"
---
...
`harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-metax-maca3.7.2.1:2.1.2-0.2.1`
...
metax-docker \
  ...
  --rm \
  -it \
  harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-metax-maca3.7.2.1:2.1.2-0.2.1 bash
```
