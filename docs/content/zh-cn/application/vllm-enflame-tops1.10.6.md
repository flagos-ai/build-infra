...
`harbor.baai.ac.cn/flagos-app/vllm0.24.0-enflame-tops1.10.6:2.1.2`
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/vllm0.24.0-enflame-tops1.10.6:2.1.2 bash
```
...
docker run --rm -it \
  ...
  -e ENFLAME_VISIBLE_DEVICES=all \
  -e TENCENT_VISIBLE_DEVICES=all \
  harbor.baai.ac.cn/flagos-app/vllm0.24.0-enflame-tops1.10.6:2.1.2 vllm-serve --model <path> --port 9000
```
