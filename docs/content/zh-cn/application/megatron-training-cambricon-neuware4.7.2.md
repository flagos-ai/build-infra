---
title: "megatron-training-cambricon-neuware4.7.2"
---
...
`harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-cambricon-neuware4.7.2:2.1.2-0.2.1`
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-cambricon-neuware4.7.2:2.1.2-0.2.1 bash
```
...
docker run --rm -it \
  --device /dev/cambricon_dev0 \
  --device /dev/cambricon_ctl \
  harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-cambricon-neuware4.7.2:2.1.2-0.2.1 megatron-train --model-type GPT
```
