---
title: "vllm-cambricon-neuware4.4.3"
---
...
`harbor.baai.ac.cn/flagos-app/vllm0.24.0-cambricon-neuware4.4.3:2.1.2`
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/vllm0.24.0-cambricon-neuware4.4.3:2.1.2 bash
```
...
docker run --rm -it \
  --device /dev/cambricon_dev0 \
  --device /dev/cambricon_ctl \
  harbor.baai.ac.cn/flagos-app/vllm0.24.0-cambricon-neuware4.4.3:2.1.2 vllm-serve --model <path> --port 9000
```
