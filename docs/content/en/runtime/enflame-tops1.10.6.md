...
<div class="ms-3"><code class="plain">harbor.baai.ac.cn/flagos-base/flagos-base-enflame-tops1.10.6:2.2.0</code> <a href="../../base/enflame-tops1.10.6/" title="View base image details" aria-label="View base image details"><i class="material-icons align-middle size-20">open_in_new</i></a></div>
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-runtime/flagos-runtime-enflame-tops1.10.6:2.2.0 bash
```
