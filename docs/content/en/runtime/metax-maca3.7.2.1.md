...
<div class="ms-3"><code class="plain">harbor.baai.ac.cn/flagos-base/flagos-base-metax-maca3.7.2.1:2.2.0</code> <a href="../../base/metax-maca3.7.2.1/" title="View base image details" aria-label="View base image details"><i class="material-icons align-middle size-20">open_in_new</i></a></div>
...
metax-docker \
  ...
  --rm \
  -it \
  harbor.baai.ac.cn/flagos-runtime/flagos-runtime-metax-maca3.7.2.1:2.2.0 bash
```
