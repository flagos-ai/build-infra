---
title: "megatron_training0.18.2-generic-12.8"
---
...
**Published:** `harbor.baai.ac.cn/flagos-app/megatron_training0.18.2-generic-12.8:2.2.0-0.3.0`

The image name is long — assign it to a variable first:

```bash
IMG=harbor.baai.ac.cn/flagos-app/megatron_training0.18.2-generic-12.8:2.2.0-0.3.0
```
