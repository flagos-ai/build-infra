---
title: "megatron_training0.18.2-hygon-dtk26.04"
---
...
**Published:** `harbor.baai.ac.cn/flagos-app/megatron_training0.18.2-hygon-dtk26.04:2.2.0-0.3.0`

The image name is long — assign it to a variable first:

```bash
IMG=harbor.baai.ac.cn/flagos-app/megatron_training0.18.2-hygon-dtk26.04:2.2.0-0.3.0
```
