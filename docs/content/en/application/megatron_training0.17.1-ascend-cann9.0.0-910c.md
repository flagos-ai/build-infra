---
title: "megatron_training0.17.1-ascend-cann9.0.0-910c"
---
...
**Published:** `harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-ascend-cann9.0.0-910c:2.2.0-0.2.3`

The image name is long — assign it to a variable first:

```bash
IMG=harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-ascend-cann9.0.0-910c:2.2.0-0.2.3
```
