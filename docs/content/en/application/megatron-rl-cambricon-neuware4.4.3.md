---
title: "megatron-rl-cambricon-neuware4.4.3"
---
...
`harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-cambricon-neuware4.4.3:2.1.2-0.2.1`
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-cambricon-neuware4.4.3:2.1.2-0.2.1 bash
```
