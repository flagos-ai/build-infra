---
title: "megatron-rl-enflame-tops1.10.6"
---
...
`harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-enflame-tops1.10.6:2.1.2-0.2.1`
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-enflame-tops1.10.6:2.1.2-0.2.1 bash
```
