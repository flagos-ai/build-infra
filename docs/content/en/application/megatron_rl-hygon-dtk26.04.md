---
title: "megatron_rl-hygon-dtk26.04"
---
...
`harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-hygon-dtk26.04:TBD-0.2.1`

The image name is long — assign it to a variable first:

```bash
IMG=harbor.baai.ac.cn/flagos-app/megatron_rl0.17.1-hygon-dtk26.04:TBD-0.2.1
```
