---
title: "megatron-training-mthreads-musa5.2.0"
---
...
`harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-mthreads-musa5.2.0:2.1.2-0.2.1`
...
docker run --rm -it \
  ...
  harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-mthreads-musa5.2.0:2.1.2-0.2.1 bash
```
...
docker run --rm -it \
  --runtime mthreads \
  --env MTHREADS_VISIBLE_DEVICES=all \
  harbor.baai.ac.cn/flagos-app/megatron_training0.17.1-mthreads-musa5.2.0:2.1.2-0.2.1 megatron-train --model-type GPT
```
