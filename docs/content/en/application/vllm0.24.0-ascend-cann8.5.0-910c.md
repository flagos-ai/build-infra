...
**Published:** `harbor.baai.ac.cn/flagos-app/vllm0.24.0-ascend-cann8.5.0-910c:2.2.0-0.3.0rc2.post2`

The image name is long — assign it to a variable first:

```bash
IMG=harbor.baai.ac.cn/flagos-app/vllm0.24.0-ascend-cann8.5.0-910c:2.2.0-0.3.0rc2.post2
```
