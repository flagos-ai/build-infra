...
| 厂商 | 后端 | App | PR | 状态 |
|---|---|---|---|---|
| 昇腾 | CANN 8.5.0 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/361 | 已合并 |
| 昇腾 | CANN 8.5.0 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/402 | 已合并 |
| 昇腾 | CANN 8.5.0 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/387 | 已合并 |
| 昇腾 | CANN 9.0.0 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/361 | 已合并 |
| 昇腾 | CANN 9.0.0 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/402 | 已合并 |
| 昇腾 | CANN 9.0.0 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/387 | 已合并 |
| 寒武纪 | NEUWARE 4.4.3 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/411 | 已合并 |
| 寒武纪 | NEUWARE 4.4.3 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/431 | 已合并 |
| 寒武纪 | NEUWARE 4.7.2 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/411 | 已合并 |
...
| 寒武纪 | NEUWARE 4.7.2 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/431 | 已合并 |
| 燧原 | TOPS 1.9.10 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/432 | 已合并 |
| 燧原 | TOPS 1.10.6 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/432 | 已合并 |
| 天数智芯 | COREX 4.4.0 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/491 | 已合并 |
| 昆仑芯 | XRE 5.37.1 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/268 | 已合并 |
| 昆仑芯 | XRE 5.37.1 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/400 | 已合并 |
| 昆仑芯 | XRE 5.37.1 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/401 | 已合并 |
| 沐曦 | MACA 3.7.2.1 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/377 | 已合并 |
| 沐曦 | MACA 3.8.1.3 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/377 | 已合并 |
...
| 清微智能 | TSM 260610 | vllm0.20.2 | https://github.com/flagos-ai/vllm-plugin-FL/pull/489 | 已合并 |
| 清微智能 | TSM 260610 | vllm0.24.0 | https://github.com/flagos-ai/vllm-plugin-FL/pull/460 | 已合并 |
