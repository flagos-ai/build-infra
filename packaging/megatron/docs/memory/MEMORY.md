# Memory Index — megatron 应用镜像工作（存放于 packaging/megatron/docs/memory/）

- [megatron-verification-state.md](megatron-verification-state.md) — 验证阶段状态快照：已定决策、待决事项、文件状态、任务
- [hygon-compiler-mask.md](hygon-compiler-mask.md) — hygon 编译器状态表（flagtree 3.6.0 与 triton 3.5.1 皆可用，同源 dtk 特判 aillvm/clang-18）+ 归并规则
