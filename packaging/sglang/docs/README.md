...
| [metax-maca3.8.1.3-zero-sgl-kernel-e2e-20260828.md](metax-maca3.8.1.3-zero-sgl-kernel-e2e-20260828.md) | 0.5.12 零 sgl-kernel 从零验证记录（F/T 双路径全过，flag_gems ConfigCache 污染处置）|
