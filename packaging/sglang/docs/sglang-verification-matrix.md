...
| 厂商 | 后端 | App | PR | 状态 |
|---|---|---|---|---|
| 昇腾 | CANN 9.0.0 | sglang0.5.18 | https://github.com/flagos-ai/sglang-plugin-FL/pull/84 | — |
| 沐曦 | MACA 3.8.1.3 | sglang0.5.18 | https://github.com/flagos-ai/sglang-plugin-FL/pull/86 | — |
...
| XRE 5.37.1 | ✅ | ⬜ | ⬜ | — |
| MACA 3.7.2.1 | ✅ | ⬜ | ⬜ | — |
| MACA 3.8.1.3 | ✅ | ⬜ | ⬜ | exp/0.5.18 新 wheel（sglang_fl-0.2.0rc0）回归双路径 E2E 全过；唯一偏差 numpy 1.26.4→2.3.5（pip 自动升级，健康） |
| MUSA 4.3.6 | ✅ | ⬜ | ⬜ | — |
| MUSA 5.2.0 | ✅ | ⬜ | ⬜ | — |
| SPACEMIT | ⬜ | ⬜ | ⬜ | 无基础镜像，排除 |
| TANGRT 1.2.0 | ✅ | ⬜ | ⬜ | — |
